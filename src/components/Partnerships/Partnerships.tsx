        ...
        <div className="mt-10">
          ...
          <div className="flex flex-col lg:flex-row gap-5 mt-10 lg:mt-16">
            <PartnerCard
              ...
              p={t('partnershipEvent1Desc')} className="w-full lg:w-1/2 shadow-lg shadow-[#a53fa79f]"/>
            <PartnerCard
              link="https://www.facebook.com/share/p/17KRLej8a1/"
              img2={img2} show="hidden" img3={img3} img={img} title={t('partnershipEvent1Title')}
              p={t('partnershipEvent1Desc')} className="w-full lg:w-1/2 shadow-lg shadow-[#a53fa79f]"/>
          </div>
          <div className="flex justify-center lg:justify-end mt-10 lg:mt-16">
            <PartnerCard
              show="block"
              link="https://www.facebook.com/share/p/17KRLej8a1/"
              img2={img2} img3={img3} img={img} title={t('partnershipEvent1Title')}
              p={t('partnershipEvent1Desc')} className="w-full lg:w-2/3 shadow-lg shadow-[#a53fa79f]"/>
          </div>
        </div>
    </div>
